...
const response: Response<AccountTransferSummary> = await client.send(new GetAccountTransferSummary({
  ...
  from: "2023-08-09T22:43:01.000000Z", // 集計期間の開始時刻
  to: "2021-03-07T03:04:59.000000Z", // 集計期間の終了時刻
...
const response: Response<PaginatedTransfers> = await client.send(new ListTransfers({
  from: "2024-07-26T19:16:05.000000Z",
  to: "2021-03-15T01:25:11.000000Z",
  page: 4265,
  per_page: 7446,
  shop_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
  shop_name: "2Ygg3AsTOryINKyRmJ3gWCDcmsuvkMrJePtGFhv4aIw1aGtGR3",
  ...
  transfer_types: ["topup", "payment", "campaign", "transfer", "exchange", "coupon"], // 取引明細の種類でフィルターします。
...
const response: Response<PaginatedTransfersV2> = await client.send(new ListTransfersV2({
  ...
  shop_name: "HGXDMcl8tuhVdB5KkP8PHvZEmmcBKkGsr9sdEDTBkey7pr4d2jpaf36YY6mrG9Y2ztoKUUUx5B1bSO8xEgnoe60dnWTCVmm3x115QsBZT6dCGgqZsePkl6iY0bdXM6Nza2rTctUJQmh0gNd3qkWY4lVW5zCUF3zWzIdrHm6OsiyHBxsWBtx4G7cLViMByCBNzcDCX5bbsPzVUGe", // 店舗名
  customer_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // エンドユーザーID
  customer_name: "D2BWp2XUNEsAtEjlivj0NhalsavWYZduuXynvh05rJdAnnKPkjJzRbGyuQYyb8948tP6VkRaNaNdjmk2wkclkjGIdrGdF8qpLKYfd3JbJX5QcdKyJ1DmsToKu4w1tRUaP7awM87Mt7bWysOyzqkBrGaMjb1", // エンドユーザー名
  transaction_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // 取引ID
  private_money_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // マネーID
  is_modified: true, // キャンセルフラグ
  transaction_types: ["exchange", "transfer", "topup", "expire"], // 取引種別 (複数指定可)、チャージ=topup、支払い=payment
  ...
  transfer_types: ["campaign", "topup", "exchange", "transfer", "expire"], // 取引明細種別 (複数指定可)
  description: "店頭QRコードによる支払い", // 取引詳細説明文
  from: "2024-12-25T20:21:57.000000Z", // 開始日時
  to: "2020-07-22T05:25:29.000000Z" // 終了日時
}));
```
