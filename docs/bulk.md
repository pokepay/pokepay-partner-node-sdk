...
const response: Response<BulkTransaction> = await client.send(new BulkCreateTransaction({
  name: "ZBy", // 一括取引タスク名
  content: "FgH8", // 取引する情報のCSV
  request_id: "TiyAaF4dUSAbqyi68iyJ302sQl233vCftoqw", // リクエストID
  description: "5tymvF1K23X2uYu46ypSW9PxtiaID1SUCfz9yEelMoF9a26c2RLHzQWOO42l0o0g8SXR", // 一括取引の説明
