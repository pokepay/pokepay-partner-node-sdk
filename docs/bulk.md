...
const response: Response<BulkTransaction> = await client.send(new BulkCreateTransaction({
  name: "KFNN9Y", // 一括取引タスク名
  content: "EWSU", // 取引する情報のCSV
  request_id: "LZdpylXeF6qvGwUl7ATMaf3NqLOcKmTPNREi", // リクエストID
  description: "EdfOxleMzyqb14XnQoYrg3WK0gxDGSVD8anN0lX3R6Ngh2OAi1BcnwfTRLJa4uoIhpR40nORwuCknsFuOeDw3ETEoYbD", // 一括取引の説明
  private_money_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // マネーID
  callback_url: "hr0AwK" // コールバックURL
}));
```
