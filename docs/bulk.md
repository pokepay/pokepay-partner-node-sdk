...
const response: Response<BulkTransaction> = await client.send(new BulkCreateTransaction({
  name: "Y8iZkaSGkcJKeradqBxAYjByUE", // 一括取引タスク名
  content: "nMr", // 取引する情報のCSV
  request_id: "rxLZOgOaoYWcJG86z8KVqUt2uzqsseXYFYKR", // リクエストID
  description: "5jWej4Zir7EPOVCpM4N6VpPYojnLWN99oUAp27dRdHXT0bu9kBbfQDVxrOePjXnEEoR26VQKj59HY9GxwaIDAEfbXDBB3FNIL8Usakbi9ZrjBPmCy", // 一括取引の説明
  private_money_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // マネーID
  callback_url: "https://riSuUZrq.example.com" // コールバックURL
}));
```
