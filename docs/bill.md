...
const response: Response<PaginatedBills> = await client.send(new ListBills({
  page: 2312, // ページ番号
  per_page: 3783, // 1ページの表示数
  bill_id: "PReFsmxa", // 支払いQRコードのID
  private_money_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // マネーID
  organization_code: "-mIjVgmYXaU5fD--UX-X", // 組織コード
  description: "test bill", // 取引説明文
  created_from: "2021-04-21T10:15:17.000000Z", // 作成日時(起点)
  created_to: "2022-02-04T10:38:43.000000Z", // 作成日時(終点)
  shop_name: "bill test shop1", // 店舗名
  shop_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // 店舗ID
  lower_limit_amount: 782, // 金額の範囲によるフィルタ(下限)
  upper_limit_amount: 1446, // 金額の範囲によるフィルタ(上限)
