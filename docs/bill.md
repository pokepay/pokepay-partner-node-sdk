...
const response: Response<PaginatedBills> = await client.send(new ListBills({
  page: 5119, // ページ番号
  per_page: 5989, // 1ページの表示数
  bill_id: "z0", // 支払いQRコードのID
  private_money_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // マネーID
  organization_code: "-ru-C-b-aF--yydG-DeO", // 組織コード
  description: "test bill", // 取引説明文
  created_from: "2025-04-21T18:46:55.000000Z", // 作成日時(起点)
  created_to: "2020-12-06T06:04:20.000000Z", // 作成日時(終点)
  shop_name: "bill test shop1", // 店舗名
  shop_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // 店舗ID
  lower_limit_amount: 279, // 金額の範囲によるフィルタ(下限)
  upper_limit_amount: 7538, // 金額の範囲によるフィルタ(上限)
