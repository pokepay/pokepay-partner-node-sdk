...
const response: Response<PaginatedBills> = await client.send(new ListBills({
  page: 6808, // ページ番号
  per_page: 867, // 1ページの表示数
  bill_id: "urlPondG", // 支払いQRコードのID
  private_money_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // マネーID
  organization_code: "oo-g6-K4-aZHq0tF-T1fTEX", // 組織コード
  description: "test bill", // 取引説明文
  created_from: "2024-04-16T23:56:11.000000Z", // 作成日時(起点)
  created_to: "2021-08-10T05:51:04.000000Z", // 作成日時(終点)
  shop_name: "bill test shop1", // 店舗名
  shop_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // 店舗ID
  lower_limit_amount: 4292, // 金額の範囲によるフィルタ(下限)
  upper_limit_amount: 459, // 金額の範囲によるフィルタ(上限)
