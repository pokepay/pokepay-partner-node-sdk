...
const response: Response<PaginatedBills> = await client.send(new ListBills({
  page: 8862, // ページ番号
  per_page: 4054, // 1ページの表示数
  bill_id: "dZdYDDGZDu", // 支払いQRコードのID
  private_money_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // マネーID
  organization_code: "-U", // 組織コード
  description: "test bill", // 取引説明文
  created_from: "2023-06-27T08:24:55.000000Z", // 作成日時(起点)
  created_to: "2023-12-23T23:15:46.000000Z", // 作成日時(終点)
  shop_name: "bill test shop1", // 店舗名
  shop_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // 店舗ID
  lower_limit_amount: 5148, // 金額の範囲によるフィルタ(下限)
  upper_limit_amount: 3642, // 金額の範囲によるフィルタ(上限)
