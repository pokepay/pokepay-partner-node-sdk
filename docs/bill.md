...
const response: Response<PaginatedBills> = await client.send(new ListBills({
  page: 3030, // ページ番号
  per_page: 64, // 1ページの表示数
  bill_id: "JfNq76RxA", // 支払いQRコードのID
  private_money_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // マネーID
  organization_code: "PcB4TMjC5VwsAv9nE0I", // 組織コード
  description: "test bill", // 取引説明文
  created_from: "2022-05-04T02:49:32.000000Z", // 作成日時(起点)
  created_to: "2022-08-21T13:19:36.000000Z", // 作成日時(終点)
  shop_name: "bill test shop1", // 店舗名
  shop_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // 店舗ID
  lower_limit_amount: 5312, // 金額の範囲によるフィルタ(下限)
  upper_limit_amount: 3569, // 金額の範囲によるフィルタ(上限)
