...
const response: Response<PaginatedBills> = await client.send(new ListBills({
  page: 2223, // ページ番号
  per_page: 8023, // 1ページの表示数
  bill_id: "zisXLLiE", // 支払いQRコードのID
  private_money_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // マネーID
  organization_code: "1r26-UfyUuJ7y3nEj6i2-NY1GkQ-2-", // 組織コード
  description: "test bill", // 取引説明文
  created_from: "2022-02-13T23:22:09.000000Z", // 作成日時(起点)
  created_to: "2023-03-04T07:41:47.000000Z", // 作成日時(終点)
  shop_name: "bill test shop1", // 店舗名
  shop_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // 店舗ID
  lower_limit_amount: 3393, // 金額の範囲によるフィルタ(下限)
  upper_limit_amount: 252, // 金額の範囲によるフィルタ(上限)
