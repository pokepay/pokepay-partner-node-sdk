...
const response: Response<CreditSession> = await client.send(new PostCreditSession({
  ...
  expires_at: "2025-08-06T09:51:30.000000Z", // セッション有効期限
...
const response: Response<CreditSessionTransactionResult> = await client.send(new CreateCreditSessionTransaction({
  ...
  description: "2WwubsLa4vnCWV1QVssD1Im12VLZ8F0u3SxrrH1vjl84VkWU20DVNhF1QRXrkYNIOtHHG8yHnSu7dDAUDz3Ba7wXTCzgYCbLTAWi1ohaetMA7WNeaonbTVSEX134CEzJmLXodVipQoaS9jpxZmBe1IVqn6l0xvjbPmp4eCBlLWO5LUEEnWeZcSGLtIalNYra", // 取引説明
  request_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx" // 冪等性キー
}));
```
