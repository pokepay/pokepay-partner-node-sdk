...
const response: Response<AccountDetail> = await client.send(new CreateUserAccount({
  ...
  name: "wbo61t0xPHohZAfXS5WAq97VI0kJjyO9S00lRKqhRSKyv4aeUNiX5kIXisF2lvLdWFAH9CECfmZyvOgcw2bcIoYI3B409EBsOM5mHn7CA1SM3xNEFCgQheyCbSnP7P0SqnjQBF0gNpyvaB", // ウォレット名
  external_id: "Hzjl", // 外部ID
