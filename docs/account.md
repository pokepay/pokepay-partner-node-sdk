...
const response: Response<AccountDetail> = await client.send(new CreateUserAccount({
  ...
  name: "2hizqeaCyQXA4kt1s5IzgftNOCeiOWbpouk4VaYSYsKX6oU3L46cfTNsJ74FdhPrGorQztiuURWZ5r1OnryKkdpmMzmoITgipjS", // ウォレット名
  external_id: "cgSjEKEvn9tkKJsfEeEirDJBvMOLUpWvpkfaBwAHAug", // 外部ID
