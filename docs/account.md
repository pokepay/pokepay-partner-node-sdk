...
const response: Response<AccountDetail> = await client.send(new CreateUserAccount({
  ...
  name: "RuldHpSuEUpdPie9qQ2GFfC0at9jn8DwInc5YWbNc2E2NkkIcBn5byBGxSlhAbqrppUqGdxMolEMce2oIWkzh6xh3kO5wXHuEli1NcEVyTrbdyJ", // ウォレット名
  external_id: "qmh3WRfGT9d54NzUibZax1gbEqwtEhHNUjZJEl7H6aH", // 外部ID
