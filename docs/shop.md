...
const response: Response<PaginatedShops> = await client.send(new ListShops({
  ...
  name: "oxスーパー三田店", // 店舗名
  postal_code: "430-8040", // 店舗の郵便番号
  address: "東京都港区芝...", // 店舗の住所
  tel: "053157027674", // 店舗の電話番号
  email: "ADg0EGo2tY@0BvA.com", // 店舗のメールアドレス
  external_id: "rU", // 店舗の外部ID
...
const response: Response<User> = await client.send(new CreateShop({
  ...
  shop_postal_code: "4338032", // 店舗の郵便番号
  shop_address: "東京都港区芝...", // 店舗の住所
  shop_tel: "0237314-319", // 店舗の電話番号
  shop_email: "hEQlphw1Dk@mThP.com", // 店舗のメールアドレス
  shop_external_id: "dPA7X1r8JT", // 店舗の外部ID
...
const response: Response<ShopWithAccounts> = await client.send(new CreateShopV2({
  name: "oxスーパー三田店", // 店舗名
  postal_code: "093-1875", // 店舗の郵便番号
  address: "東京都港区芝...", // 店舗の住所
  tel: "08292-822", // 店舗の電話番号
  email: "cNMgqN77FQ@wuiG.com", // 店舗のメールアドレス
  external_id: "W4pnFSkfz0ZAYuHKEr", // 店舗の外部ID
  organization_code: "ox-supermarket", // 組織コード
...
const response: Response<ShopWithAccounts> = await client.send(new UpdateShop({
  shop_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // 店舗ユーザーID
  name: "oxスーパー三田店", // 店舗名
  postal_code: "180-8467", // 店舗の郵便番号
  address: "東京都港区芝...", // 店舗の住所
  tel: "082780-1734", // 店舗の電話番号
  email: "xt1HL4wWzm@kMDA.com", // 店舗のメールアドレス
  external_id: "VfWD13Zj3L9DQPYajb0t", // 店舗の外部ID
