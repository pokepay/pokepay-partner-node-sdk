...
test('Check UpdateCoupon | 31', async () => {
  ...
  try {
    const response: Response<CouponDetail> = await client.send(new UpdateCoupon({
      ...
      is_hidden: true,
      is_disabled: false,
      display_ends_at: "2024-08-29T15:40:27.000000Z",
      display_starts_at: "2025-12-18T15:07:55.000000Z",
      ends_at: "2025-04-06T03:31:25.000000Z",
      starts_at: "2024-09-29T21:00:28.000000Z",
      discount_upper_limit: 9113,
      description: "107OaiUpqdHMS0BnQNQ8yntRPdiO7nDWAmmXsETvex6EwUtMqxtCSMEZWLR3IYMZqZQp71KYV2dqAhSRH0jBaTj6CKr7da3Hc5MrDSrYQmTFD8MK4LhwIRladKEnUCUBMTsHjSLXQWZdqZHXOS9NchMxuvMOV5pE0ThIcNVnpd1n04FvafoOT5XflXygJfyBJl1nws6Ne3S7kdp",
      name: "li9FCf9vj51iwXi5vVkai7fMidPllBkchJ2ELHNBkuEPtWGn6U1tknXv7iBjpuz8kXfTQVtq7"
    }));
    status = response.code;
  } catch (e) {
    if (axios.isAxiosError(e) && e.response) {
...
test('Check UpdateCoupon | 32', async () => {
  ...
  try {
    const response: Response<CouponDetail> = await client.send(new UpdateCoupon({
      coupon_id: "7b9ed992-5c23-408e-b60f-794ed31ccee5",
      discount_amount: 4061,
      discount_percentage: 5525.0,
      is_shop_specified: true,
      min_amount: 345,
      usage_limit: 2387,
      code: "g6A5q48d",
      ...
      is_hidden: false,
      is_disabled: true,
      display_ends_at: "2021-06-13T10:21:16.000000Z",
      display_starts_at: "2025-01-26T17:29:41.000000Z",
      ends_at: "2024-08-20T07:23:34.000000Z",
      starts_at: "2021-10-16T08:05:51.000000Z",
      discount_upper_limit: 7400,
      description: "qvZRxaI0AVDH5phIrM988xOpACBuWehCLI5Ithzpo1sbw0fi8Tfl4MiezYuuDN5NO2HkiJUlQ4dKgR3uo3pyHQKCLEzAV2HW0T6",
      name: "wtgF"
    }));
    status = response.code;
  } catch (e) {
...
test('Check UpdateCoupon | 34', async () => {
  ...
  try {
    const response: Response<CouponDetail> = await client.send(new UpdateCoupon({
      coupon_id: "7b9ed992-5c23-408e-b60f-794ed31ccee5",
      discount_amount: 4622,
      discount_percentage: 4771.0,
      storage_id: "33ebf742-a675-4db7-848c-e2435b517998",
      available_shop_ids: ["24d9314e-8c67-4834-a1d5-2dc04a2def2b", "4b63418b-b0b7-40a9-8201-a8ece2fb7eab", "f0713857-bf73-484e-ab45-a343718c8792", "c250adc6-b1bf-4ad7-81b4-3ee84e6f8348", "90e4be6c-749a-49db-b608-eadc6d0109a8", "40b041f4-e463-4e16-aaaf-4e47156ad874", "9a306397-edc9-4924-8050-15e1815d487c", "74be2e05-c81d-4a91-a4d3-17cb506ba969", "54ba66d6-e5d8-4816-b874-8bb6ceb794fb", "bb6ad849-dc82-481b-b550-661b3762085f"],
      is_shop_specified: false,
      min_amount: 8257,
      usage_limit: 8166,
      code: "h1iS",
      ...
      is_hidden: true,
      is_disabled: true,
      display_ends_at: "2024-05-11T12:15:43.000000Z",
      display_starts_at: "2021-12-08T17:59:09.000000Z",
...
test('Check UpdateCoupon | 35', async () => {
  ...
  try {
    const response: Response<CouponDetail> = await client.send(new UpdateCoupon({
      ...
      num_recipients_cap: 1411,
      storage_id: "7f839a01-81c4-4d52-a1fe-e3890618cd0d",
      available_shop_ids: ["f31580f8-af0d-41a7-882b-01bbb2eb53ad", "532e485e-6b1a-4532-ae41-2d01830d1e3e", "f0b8a38e-0464-48d2-a7e8-cab4ef2aa255", "306b34b2-ec99-4bc7-896e-3d6aa7699e2f", "f91ae636-9d23-4c48-a96c-9172c9d45c66", "3b2c8a9c-b19c-4ca2-b31a-3b9740de009c", "0042f1bf-64cb-4e81-acbb-c4d0573a7404", "74275283-2790-4a18-acc9-4edb865a112b", "2c7c3723-1e95-4a90-8529-15f824950f0b", "ba2bf206-e912-46a3-b289-2ad808949865"],
      is_shop_specified: true,
      min_amount: 6683,
      usage_limit: 4341,
      code: "KxrV4x",
      ...
      is_hidden: true,
      is_disabled: false,
      display_ends_at: "2023-06-09T12:41:44.000000Z",
      display_starts_at: "2021-01-26T13:21:34.000000Z",
      ends_at: "2023-12-22T08:09:40.000000Z",
      starts_at: "2024-07-05T09:38:34.000000Z",
      discount_upper_limit: 1426,
      description: "BywKIciMlN0S7L0N0uBHj0xIlmI7crwjgiJmBq8x2BMoiejWmPY8qwKCFWRUhTWJtrSHM5KvGCx3jvLeQXqJ7fOtRApW564YK0LvLN69VHlYJhXH6cUQL7XLfiXA0zUZ8WIiKSeWU9z6lAbD3wpFlmsWusC8RGaB",
      name: "UJdHLf9kwaxRbmzAo5vzrqC43kvR5VzS4JSx7Qk5qYm8EJV1By6vGk0FuWZ3ptkSyNBcc9paWacd"
    }));
    status = response.code;
  } catch (e) {
    if (axios.isAxiosError(e) && e.response) {
...
test('Check UpdateCoupon | 37', async () => {
  ...
  try {
    const response: Response<CouponDetail> = await client.send(new UpdateCoupon({
      coupon_id: "7b9ed992-5c23-408e-b60f-794ed31ccee5",
      discount_percentage: 4106.0,
      name: "lF8sKq6M8TMch0t9MLsXgvG8EYKbsPpBkO0z5h9VDX3NEhsO0rjGagOIQ6x9sSfu0zX8zdCniT7rbp4RdF8jzLLX07kGwmRZR89QJDyeQCnprhi7qh3KP4T"
    }));
    status = response.code;
  } catch (e) {
    if (axios.isAxiosError(e) && e.response) {
...
test('Check UpdateCoupon | 38', async () => {
  ...
  try {
    const response: Response<CouponDetail> = await client.send(new UpdateCoupon({
      ...
      description: "Wi9g9nZZhOiq9TM1kLnMOaPoayQ1SL4LwXctk2uyuazqzFpngLk90ZBFe71DIECbUavopCer6amUqWii2uDVrmTki6pqO0f8cnptMkBRjmpnnbeCg4xumOoxK0oT4F795unttA065Yr03Qzj1SYSblk7QSMdkkKP",
      name: "tzfsCSKaR3OFn1WKJz5hhBZBCZgSERTDaoK9IqITw9RXh5VLaBXSS3EzsrMpj8GBIyJaRyweuGKy2nXN4UBPwGQ9mhvxLr7QQxCiR4LJ0VAGQ0LknXB"
    }));
    status = response.code;
  } catch (e) {
    if (axios.isAxiosError(e) && e.response) {
...
test('Check UpdateCoupon | 39', async () => {
  ...
  try {
    const response: Response<CouponDetail> = await client.send(new UpdateCoupon({
      coupon_id: "7b9ed992-5c23-408e-b60f-794ed31ccee5",
      discount_percentage: 6564.0,
      discount_upper_limit: 5501,
      description: "XV6IePzMvb8rIAKhBAUImOpB9NJd0FGb0jOdIa2VbV1E7pIBf60ZOpXb0uUTjEzrW5FEq6VpVqu1DpFd0JaBsPBEjjxsN82R5bV74h6MclFLskpVJhF8OvhWGp3gTZC60RTw4fZ8zWBqSC3vDIMcnooU2vsEkhFzbMP7H4x70jy8CyXSjsNQfhm4JdiSR8LU0sAxVpKo9Pr8tnCR4b3VVcn",
      name: "R7ySaTJSLXaRbjFaOCY9HY0faJMcRsZ3tfn14pqdpY2"
    }));
    status = response.code;
  } catch (e) {
    if (axios.isAxiosError(e) && e.response) {
...
test('Check UpdateCoupon | 40', async () => {
  ...
  try {
    const response: Response<CouponDetail> = await client.send(new UpdateCoupon({
      coupon_id: "7b9ed992-5c23-408e-b60f-794ed31ccee5",
      discount_percentage: 654.0,
      starts_at: "2024-02-18T17:09:47.000000Z",
      discount_upper_limit: 7899,
      description: "gOVzxC2AMFcqtkzhdfPKiy9SERDVnpaYhOvVB8b8Y5rPTIoQafvlfkuyBchbjOVFfaAmwoPiUeFs2qGGZk77FXigkPx1N",
      name: "C7bcdhHDyq2BmegmNcooOzsV0UAnFDq2j42XbKSjWX0mczdG92I3EQWa6MviKhzgN1WE1E9QE8I1WOtKGTOoDsggK2zVvIrNmjPyMt7JZTknlcSLOAfgHki7iEUUEZs"
    }));
    status = response.code;
  } catch (e) {
    if (axios.isAxiosError(e) && e.response) {
...
test('Check UpdateCoupon | 41', async () => {
  ...
  try {
    const response: Response<CouponDetail> = await client.send(new UpdateCoupon({
      coupon_id: "7b9ed992-5c23-408e-b60f-794ed31ccee5",
      discount_percentage: 89.0,
      ends_at: "2020-03-04T13:50:21.000000Z",
      starts_at: "2021-08-13T10:19:36.000000Z",
      discount_upper_limit: 8521,
      description: "8w6YX9AjYRSoiU1BYQYTGkBMdZ9gxwOlUDOeBSRiyqeameMaY0bgN8gTUkelv3hkGmk4iWQZAVafOlabiOcEnloh2DXft8ZR3ZIT5H8aSOl3MDXnG9yHqEAThwDuq1zewsMIx1hpzHiKxcCexEPrWNcD1BCJ2Q7A3yxMyBqUSnmfmyMf158jbodxUJxcIS6QwIFvAWCZsB1EYOxuNXsb8K4XyQ60l6nZCLpElUd6iH1X66E0nqBBGmKnZ6uD",
      name: "In3iuFQrrgeXzyNXNrNkeWa9hWsLSo6RhlR"
    }));
    status = response.code;
  } catch (e) {
    if (axios.isAxiosError(e) && e.response) {
...
test('Check UpdateCoupon | 42', async () => {
  ...
  try {
    const response: Response<CouponDetail> = await client.send(new UpdateCoupon({
      coupon_id: "7b9ed992-5c23-408e-b60f-794ed31ccee5",
      discount_percentage: 4352.0,
      display_starts_at: "2021-04-11T21:49:58.000000Z",
      ends_at: "2020-02-23T21:03:14.000000Z",
      starts_at: "2025-04-07T13:55:57.000000Z",
      discount_upper_limit: 6748,
      description: "tyDW12s5SKsd06fYHa9pHdUJ2NkpD9XRln1g4q1AmzenaBAIYsPX5BEVEkSwN7Jl7UfMqNeIWxDQ5mYkDBp76iPlz0WyF7I2Snzg812cd0lMhCHFE2kwBpeHriIaXxYmUfeD23BKTCZPKhRk3w9r2MS5qnBpeG29hBWbNKIGuoyWD3BHeU5bcdtREmG3PoPoUnVURoRDP0303M0EUzCR0XC7UBINwESq7h",
      name: "Py7a3F5MBC2C7VfANu3p62KDWO8TDrLXiDq8ZM4HpSJ7ezaoKVM6PG4nVxadlDXYh8F3jX5Rw62VEObOlMsiJRl1b2ESaJKCD"
    }));
    status = response.code;
  } catch (e) {
    if (axios.isAxiosError(e) && e.response) {
...
test('Check UpdateCoupon | 43', async () => {
  ...
  try {
    const response: Response<CouponDetail> = await client.send(new UpdateCoupon({
      ...
      display_ends_at: "2025-08-20T08:11:22.000000Z",
      display_starts_at: "2023-09-24T17:08:22.000000Z",
      ends_at: "2022-11-27T23:49:37.000000Z",
      starts_at: "2023-07-02T04:39:34.000000Z",
      discount_upper_limit: 4504,
      description: "CVaIjvXY9buv1PGDaqpxNAcB7XJ2PMH0HA7mMCxlziaJ1nphI9ySRxw6pdyrj7YEb5BIbPwZWptKeWMAfjTzhjO10bQwyTU6ZUhrOp80a47LYIcD579HHiydYwYbStQsIHShYuqMOfry8huKLaun9q8fRCMt2pzYekawpUouvYHK",
      name: "lj0GUL0Fcnz7fEngR6pF3m54VmwYrgFgT3RyUt1"
    }));
    status = response.code;
  } catch (e) {
    if (axios.isAxiosError(e) && e.response) {
...
test('Check UpdateCoupon | 44', async () => {
  ...
  try {
    const response: Response<CouponDetail> = await client.send(new UpdateCoupon({
      ...
      is_disabled: true,
      display_ends_at: "2023-01-26T06:20:22.000000Z",
      display_starts_at: "2025-12-11T15:10:03.000000Z",
...
test('Check UpdateCoupon | 46', async () => {
  ...
  try {
    const response: Response<CouponDetail> = await client.send(new UpdateCoupon({
      ...
      is_hidden: true,
      is_disabled: false,
      display_ends_at: "2022-05-31T08:38:31.000000Z",
      display_starts_at: "2024-01-09T14:28:19.000000Z",
      ends_at: "2021-02-01T09:43:50.000000Z",
      starts_at: "2023-01-14T02:43:23.000000Z",
...
test('Check UpdateCoupon | 47', async () => {
  ...
  try {
    const response: Response<CouponDetail> = await client.send(new UpdateCoupon({
      ...
      is_hidden: false,
      is_disabled: false,
      display_ends_at: "2024-05-26T21:33:43.000000Z",
      display_starts_at: "2020-05-19T20:00:28.000000Z",
      ends_at: "2023-07-04T04:01:37.000000Z",
      starts_at: "2024-01-28T22:33:31.000000Z",
      discount_upper_limit: 2575,
      description: "u0i2E7e3WCog3HknLhb4mGHjaX24jJAlJFQ82MhyQQoipgFNSux0jeobdQD1VXjUggH7qMtHhSfZdXUyjb1NxKa8yAWf3eI4rn2GKxT8MfsHveV88627AlMJYf8MI0c9iCp3raZonaiD",
      name: "zAfoVN5ZcNoMxEFE11voG9m7gWIlidcsFhnnSlOPQSKVW980GqQVfPuvUPiEFV6mDyiAjmPC8FhIFplNkUQpOFZAAuAkdYYYV8"
    }));
    status = response.code;
  } catch (e) {
    if (axios.isAxiosError(e) && e.response) {
...
test('Check UpdateCoupon | 48', async () => {
  ...
  try {
    const response: Response<CouponDetail> = await client.send(new UpdateCoupon({
      coupon_id: "7b9ed992-5c23-408e-b60f-794ed31ccee5",
      discount_percentage: 3642.0,
      usage_limit: 9648,
      code: "2",
      is_public: true,
      is_hidden: true,
      is_disabled: true,
      display_ends_at: "2022-10-08T07:36:27.000000Z",
      display_starts_at: "2025-06-01T10:15:24.000000Z",
      ends_at: "2022-08-13T22:09:08.000000Z",
      starts_at: "2023-10-22T08:24:23.000000Z",
      discount_upper_limit: 7295,
      description: "7ePIgPu4dPH7I",
      name: "mSF7bIQ97lNoNEqqi11P4GN23Eb6NlDd7BTwpYu4Valw5xiIJ7Q1Cipp2CPMR"
    }));
    status = response.code;
  } catch (e) {
    if (axios.isAxiosError(e) && e.response) {
...
test('Check UpdateCoupon | 49', async () => {
  ...
  try {
    const response: Response<CouponDetail> = await client.send(new UpdateCoupon({
      ...
      is_hidden: false,
      is_disabled: true,
      display_ends_at: "2025-02-03T19:47:33.000000Z",
      display_starts_at: "2025-09-27T09:44:30.000000Z",
...
test('Check UpdateCoupon | 50', async () => {
  ...
  try {
    const response: Response<CouponDetail> = await client.send(new UpdateCoupon({
      ...
      is_hidden: true,
      is_disabled: false,
      display_ends_at: "2024-09-12T01:01:17.000000Z",
      display_starts_at: "2023-03-02T06:38:40.000000Z",
      ends_at: "2020-10-07T04:55:41.000000Z",
      starts_at: "2020-10-03T20:34:30.000000Z",
      discount_upper_limit: 2829,
      description: "Ms6AqPF1N4VGIihJYcZH1yqyLKdrb7VdvBferrdPPsgFTBp21GVpuNthlN8cTNxtClPP",
...
test('Check UpdateCoupon | 51', async () => {
  ...
  try {
    const response: Response<CouponDetail> = await client.send(new UpdateCoupon({
      ...
      available_shop_ids: ["0f336e9d-6c00-4c2a-b986-41722f1b6d5f", "2daa7017-b421-400e-949e-44b6517fc2de", "027a1e1b-e808-4a46-8ed7-69fe4feae4d3", "f4951ce5-0e0f-4fe9-904a-cedc51aa8f95", "479def8e-3a44-4d14-ab3b-2b5b62e2c1e1", "172ac927-5a00-44ce-ab47-badeb892b2d5", "ae68d289-6019-4311-94aa-87d5f40630c6", "c796c8f9-b91b-4fdd-b3b7-f1a818d843e6"],
      is_shop_specified: false,
      min_amount: 4629,
      usage_limit: 5562,
      code: "BCxguWk",
...
test('Check UpdateCoupon | 52', async () => {
  ...
  try {
    const response: Response<CouponDetail> = await client.send(new UpdateCoupon({
      ...
      storage_id: "785fe931-88b8-4bef-bf7d-f1bf73794312",
      available_shop_ids: ["43405e52-9112-4df0-a7c3-fbc0454cda1d"],
      is_shop_specified: false,
      min_amount: 4628,
      usage_limit: 687,
      code: "iEOfs",
      ...
      is_hidden: false,
      is_disabled: false,
      display_ends_at: "2025-09-04T07:52:11.000000Z",
      display_starts_at: "2026-01-15T21:01:39.000000Z",
      ends_at: "2023-06-21T16:01:16.000000Z",
      starts_at: "2020-08-04T10:18:28.000000Z",
      discount_upper_limit: 1297,
      description: "zPm5pmHiztzTLcjSeNyveotr1SbLY9f9RM3h2SXQaAm6iMSYVoPQWfV62UhTGJS1L9KLOsA2Q2Z23Mwd98ipOldTUQCXPcZtLDZ6t1d7NhS3tIbiaQ9UqJHQZFkEmVia7WMZwoONY9mYcjUD3BWfN3hpObBbd0WPCuqh90wn",
      name: "UEefdvvGn56xgqcINC0MaOVTzOYUS4YiFzadS1dG4VhC"
    }));
    status = response.code;
  } catch (e) {
    if (axios.isAxiosError(e) && e.response) {
...
test('Check UpdateCoupon | 53', async () => {
  ...
  try {
    const response: Response<CouponDetail> = await client.send(new UpdateCoupon({
      coupon_id: "7b9ed992-5c23-408e-b60f-794ed31ccee5",
      discount_percentage: 1051.0,
      num_recipients_cap: 1117,
      storage_id: "98b20641-59fb-4ed8-a4a1-aa3e09ef17e0",
      available_shop_ids: ["0cd02fae-c69c-434c-a70b-bbbd21bf02e3", "9a67cdae-c2f5-4da8-b3ce-9c6b5770c650", "b5f90f3d-02b9-42a5-b2a8-739534101c95", "e535235b-3c80-47ec-8548-ed169cdd323c", "f0bf3a41-851a-4c60-b4c2-7f724676920e", "e291f008-c7a4-4782-b589-1775af8d8c0c", "cf5cdd98-c1cd-4053-a7b7-762dd15a2128"],
      is_shop_specified: false,
      min_amount: 6790,
      usage_limit: 2470,
      code: "2h9L5UgNjF",
      ...
      is_hidden: false,
      is_disabled: true,
      display_ends_at: "2026-03-04T23:28:02.000000Z",
      display_starts_at: "2025-06-06T14:45:04.000000Z",
      ends_at: "2024-09-18T11:51:35.000000Z",
      starts_at: "2026-01-25T17:08:55.000000Z",
      discount_upper_limit: 4440,
      description: "",
      name: "QfzzTwn3Dxt4Xew7YzDaZ1J9OdsQM2IVUV93tsgTE0JEew3e"
    }));
    status = response.code;
  } catch (e) {
    if (axios.isAxiosError(e) && e.response) {
