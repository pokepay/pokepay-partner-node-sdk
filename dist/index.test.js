...
test('Check GetAccountTransferSummary | 0', async () => {
    let status = 400;
    try {
        const response = await client.send(new index_1.GetAccountTransferSummary({
...
test('Check CreatePaymentTransaction | 0', async () => {
    ...
    try {
        const response = await client.send(new index_1.CreatePaymentTransaction({
            shop_id: "e0111ac5-08fd-4245-8a46-30f306051dbc",
            customer_id: "547ba588-da25-4d37-92d5-6cd2f29aeafe",
            private_money_id: "d66598e9-1e4a-4a48-a617-dd8e9f798236",
            amount: 109
        }));
        status = response.code;
    }
...
test('Check CreateCpmTransaction | 0', async () => {
    ...
    try {
        const response = await client.send(new index_1.CreateCpmTransaction({
            cpm_token: "emzRdROKbGph7rDrumGN6t",
            shop_id: "453a840a-8fd1-4ba3-9098-25b3cc476976",
            amount: 858.0
        }));
        status = response.code;
    }
...
test('Check CreateTransferTransaction | 0', async () => {
    ...
    try {
        const response = await client.send(new index_1.CreateTransferTransaction({
            sender_id: "52f8252d-f94c-4fc1-82ab-f98fc7c85bbe",
            receiver_id: "50cc933e-1efa-488e-94cc-cc031b84ad53",
            private_money_id: "f5e2edb5-db1c-46c1-bebf-d6a4e02c5fe7",
            amount: 5548.0
        }));
        status = response.code;
    }
...
test('Check CreateExchangeTransaction | 0', async () => {
    ...
    try {
        const response = await client.send(new index_1.CreateExchangeTransaction({
            user_id: "a3a3a397-2b0a-4fdf-962b-b65524f446a7",
            sender_private_money_id: "451fb425-d1a1-4343-93da-4b8d5acb45a3",
            receiver_private_money_id: "aba0c4bc-8956-4382-a45f-5434bc75ede3",
            amount: 3570.0
        }));
        status = response.code;
    }
...
test('Check BulkCreateTransaction | 0', async () => {
    ...
    try {
        const response = await client.send(new index_1.BulkCreateTransaction({
            name: "3IQKQQHb6fikVg8U3XBig",
            content: "3jy",
            request_id: "a01cL7edhmrVi5NIsblUeDquiQL8YRreNoLA"
        }));
        status = response.code;
    }
    catch (e) {
...
test('Check GetTransaction | 0', async () => {
    ...
    try {
        const response = await client.send(new index_1.GetTransaction({
            transaction_id: "350f8125-1cad-47fa-bbca-69465dbbae5f"
        }));
        status = response.code;
    }
    catch (e) {
...
test('Check RefundTransaction | 0', async () => {
    ...
    try {
        const response = await client.send(new index_1.RefundTransaction({
            transaction_id: "0872be14-d7bc-4da7-b080-b61946532afa"
        }));
        status = response.code;
    }
    catch (e) {
...
test('Check CreateExternalTransaction | 0', async () => {
    ...
    try {
        const response = await client.send(new index_1.CreateExternalTransaction({
            shop_id: "73a82581-8b6a-498e-a58b-8da7d438be1e",
            customer_id: "f5552e10-b0be-480e-8ec7-586b6ee31d5d",
            private_money_id: "5f469105-5e65-4dbc-9fd2-1979ca04045a",
            amount: 4803
        }));
        status = response.code;
    }
...
test('Check RefundExternalTransaction | 0', async () => {
    ...
    try {
        const response = await client.send(new index_1.RefundExternalTransaction({
            event_id: "51ab617e-b1cb-4a80-bb2e-9109284e621e"
        }));
        status = response.code;
    }
    catch (e) {
...
test('Check ListTransfersV2 | 0', async () => {
    let status = 400;
    try {
        const response = await client.send(new index_1.ListTransfersV2());
        status = response.code;
    }
    catch (e) {
        if (axios_1.default.isAxiosError(e) && e.response) {
...
test('Check CreateOrganization | 0', async () => {
    ...
    try {
        const response = await client.send(new index_1.CreateOrganization({
            ...
            private_money_ids: ["a90703b8-10b8-4b01-9673-1b0a6f58a9ec", "13246a37-41f2-40d3-9240-d5ae28938dd7", "ae0d5b9a-ca9c-41cb-8e5d-e40e3ceae04e", "0523fa39-0213-406f-90fd-7f5139553d01", "c369776a-0dc8-4e89-8d2e-41f31a3bf73e", "1f484c94-d8bf-4c4e-9834-41b89cc1c5d6"],
            issuer_admin_user_email: "kSyiuzE1L2@wv36.com",
            member_admin_user_email: "YuE4jwp0Ii@R44I.com"
        }));
        status = response.code;
    }
    catch (e) {
...
test('Check CreateShop | 0', async () => {
    ...
    try {
        const response = await client.send(new index_1.CreateShop({
            shop_name: "6zLcwMHaeJGFXqwAY75stQD6SAh41fZii84vybd1Jsf0jR3rzbwtxyn2FAh1zUedGEpNztrZH4AytTHxVvHVgjPvTnTRbAGxJFBzSBdN9rH7Ml90EeuZgaP20pyyEjfyZnRCBHpzVqBZqNRFUo9BhqQxq9FR8VF2gH7EAn"
        }));
        status = response.code;
    }
    catch (e) {
...
test('Check GetShop | 0', async () => {
    ...
    try {
        const response = await client.send(new index_1.GetShop({
            shop_id: "4dee57f0-b2af-4d6f-994f-1ceba06f8986"
        }));
        status = response.code;
    }
    catch (e) {
...
test('Check UpdateShop | 0', async () => {
    ...
    try {
        const response = await client.send(new index_1.UpdateShop({
            shop_id: "254dad4c-c959-4c89-a25d-784a6bc800cd"
        }));
        status = response.code;
    }
    catch (e) {
...
test('Check GetPrivateMoneyOrganizationSummaries | 0', async () => {
    ...
    try {
        const response = await client.send(new index_1.GetPrivateMoneyOrganizationSummaries({
            private_money_id: "8e06885f-39ba-4523-bab0-7afd6cf47968"
        }));
        status = response.code;
    }
    catch (e) {
...
test('Check GetPrivateMoneySummary | 0', async () => {
    ...
    try {
        const response = await client.send(new index_1.GetPrivateMoneySummary({
            private_money_id: "bd0531bd-47b0-4b84-b34d-73ee35853f8c"
        }));
        status = response.code;
    }
    catch (e) {
...
test('Check ListCustomerTransactions | 0', async () => {
    ...
    try {
        const response = await client.send(new index_1.ListCustomerTransactions({
            private_money_id: "9aeda297-0da1-408d-a7da-43b4395e855b"
        }));
        status = response.code;
    }
    catch (e) {
...
test('Check GetBulkTransaction | 0', async () => {
    ...
    try {
        const response = await client.send(new index_1.GetBulkTransaction({
            bulk_transaction_id: "3bc1ff09-4879-44ea-bb33-454222aabdc5"
        }));
        status = response.code;
    }
    catch (e) {
...
test('Check ListBulkTransactionJobs | 0', async () => {
    let status = 400;
    try {
        const response = await client.send(new index_1.ListBulkTransactionJobs({
            bulk_transaction_id: "370e4c3f-9576-4059-be3e-40f0c8aff2bf"
        }));
        status = response.code;
    }
    catch (e) {
...
test('Check CreateCashtray | 0', async () => {
    ...
    try {
        const response = await client.send(new index_1.CreateCashtray({
            private_money_id: "c2d9df2d-94a7-473e-9cd4-78e2e8a7301e",
            shop_id: "9baa4f75-edf9-4153-8940-cfa69c0fe018",
            amount: 3449.0
        }));
        status = response.code;
    }
...
test('Check GetCashtray | 0', async () => {
    ...
    try {
        const response = await client.send(new index_1.GetCashtray({
            cashtray_id: "8cc3a555-89ae-400f-a868-4105ad42950d"
        }));
        status = response.code;
    }
    catch (e) {
...
test('Check CancelCashtray | 0', async () => {
    ...
    try {
        const response = await client.send(new index_1.CancelCashtray({
            cashtray_id: "19086e28-d892-4421-8df0-ce2bdda0fe8a"
        }));
        status = response.code;
    }
    catch (e) {
...
test('Check UpdateCashtray | 0', async () => {
    ...
    try {
        const response = await client.send(new index_1.UpdateCashtray({
            cashtray_id: "18813a8a-6d45-41ba-ae96-7b2e782ea488"
        }));
        status = response.code;
    }
    catch (e) {
...
test('Check CreateCampaign | 0', async () => {
    ...
    try {
        const response = await client.send(new index_1.CreateCampaign({
            name: "iW2qUm4FbQucsmz0GYwY85K8kF9CcO2FCZ7wQECuEigH9T54l9EXWThBhNBtq0Hlr5VUDcRjPWhcWE5Ed0Dp6qm5enNIYlp4WuULLQB3hzZG357PPnWlMQlOO65IFrI1BJMiWPv5dAbUBWta68v79KNgsodWT1kP64chZLEzZTeXAsCUOeSILicKJugPMhkbNW44x5lpizelx6Zw3",
            private_money_id: "ead5fdc1-eace-405d-ab24-f9a7ec283ddf",
            starts_at: "2025-05-29T01:15:34.000000+09:00",
            ends_at: "2024-10-31T15:21:17.000000+09:00",
            priority: 4691,
            event: "payment"
        }));
        status = response.code;
...
test('Check ListCampaigns | 0', async () => {
    ...
    try {
        const response = await client.send(new index_1.ListCampaigns({
            private_money_id: "e6344f05-84e1-4e0f-9035-4e96e13460a4"
        }));
        status = response.code;
    }
    catch (e) {
...
test('Check GetCampaign | 0', async () => {
    ...
    try {
        const response = await client.send(new index_1.GetCampaign({
            campaign_id: "a937e186-7127-4086-86b2-ebffae347414"
        }));
        status = response.code;
    }
    catch (e) {
...
test('Check UpdateCampaign | 0', async () => {
    ...
    try {
        const response = await client.send(new index_1.UpdateCampaign({
            campaign_id: "24843925-ee37-495f-9239-8947fc9ec563"
        }));
        status = response.code;
    }
    catch (e) {
...
test('Check RequestUserStats | 0', async () => {
    let status = 400;
    try {
        const response = await client.send(new index_1.RequestUserStats({
...
test('Check CreateWebhook | 0', async () => {
    let status = 400;
    try {
        const response = await client.send(new index_1.CreateWebhook({
...
test('Check ListWebhooks | 0', async () => {
    let status = 400;
    try {
        const response = await client.send(new index_1.ListWebhooks());
        status = response.code;
    }
    catch (e) {
        if (axios_1.default.isAxiosError(e) && e.response) {
...
test('Check UpdateWebhook | 0', async () => {
    let status = 400;
    try {
        const response = await client.send(new index_1.UpdateWebhook({
            webhook_id: "97edf707-c7c9-4efb-8b34-92af407b3cb4"
        }));
        status = response.code;
    }
    catch (e) {
...
test('Check ListCoupons | 0', async () => {
    let status = 400;
    try {
        const response = await client.send(new index_1.ListCoupons({
            private_money_id: "058bd53c-2f9f-4dcf-9614-04fd1b70f74b"
        }));
        status = response.code;
    }
    catch (e) {
...
test('Check GetCoupon | 0', async () => {
    let status = 400;
    try {
        const response = await client.send(new index_1.GetCoupon({
            coupon_id: "eac7ba0c-adfa-4994-9007-c85f7a46f6d3"
        }));
        status = response.code;
    }
    catch (e) {
